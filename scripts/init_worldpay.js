WorldpayCheckout = function( $ ) {
    ...
    var reattachHandlers = function() {
        ...
        if ( document.getElementById('order_review') || document.getElementById('add_payment_method') ) {
    ...
    return {
        setupNewCardForm: function(){
            form = document.getElementsByName('checkout')[0] || document.getElementById('order_review') || document.getElementById('add_payment_method');
                ...
                'callback': function(response) {
                  if (response && response.token) {
                    ...
                    if( document.getElementById('add_payment_method') ) {
                        Worldpay.formBuilder(form, 'input', 'hidden', 'worldpay_response', JSON.stringify(response) );
                    }
